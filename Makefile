...
# Linkage
$(BIN_DIR)/$(TARGET): $(OBJ_DIR)/y.tab.o $(OBJ_DIR)/matc.o $(OBJ_DIR)/matrix.o $(OBJ_DIR)/types.o $(OBJ_DIR)/symbol_table.o $(OBJ_DIR)/ast.o
	$(CC) -o $@ $^ $(LDFLAGS)
...
$(OBJ_DIR)/symbol_table.o: $(SRC_DIR)/symbol_table.c $(INCLUDE_DIR)/symbol_table.h $(INCLUDE_DIR)/types.h
	$(CC) $(CFLAGS) -o $@ $<
